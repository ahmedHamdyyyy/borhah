...
class MyTheme {
  ...
  Color.fromRGBO(18, 9, 1, 1); // this color is a dropshadow of
  static Color soft_accent_color = Color.fromRGBO(254, 234, 209, 1);
  static Color splash_screen_color = Color.fromRGBO(
      3, 2, 23, 1); // if not sure , use the same color as accent color
  ...
  //---------------
  static const Color brick_red = Color.fromRGBO(96, 43, 2, 1.0);
