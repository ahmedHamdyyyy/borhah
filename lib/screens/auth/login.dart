  ...
  onPressedGoogleLogin() async {
    try {
      ...
      if (googleUser == null) {
        Loading.close();
        if (mounted) {
          ToastComponent.showDialog("Sign in cancelled");
        }
        return;
      }
      ...
      if (accessToken == null) {
        Loading.close();
        if (mounted) {
          ToastComponent.showDialog("Authentication failed");
        }
        return;
      }
      ...
      if (loginResponse.result == false) {
        ToastComponent.showDialog(loginResponse.message ?? "Login failed");
        return;
      }
      ...
      Loading.close();
      if (mounted) {
        ToastComponent.showDialog("Login failed");
      }
    }
  }
